	...
	return (
		<div className={styles.group}>
			...
			<div className={styles.group__users_list}>
				...
				{!usersError &&
					users &&
					users.map((user) => <span>{user.user.name}</span>)}
